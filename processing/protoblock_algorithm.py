...
class ProtoblockAlgorithm(QgsProcessingAlgorithm):
    ...
    def shortHelpString(self):
        return self.tr(
            "Generates protoblocks by fetching and processing OSM street data within the extent of an input polygon layer."
        )
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(
            QgsProcessingParameterFeatureSink(
                self.OUTPUT_PROTOBLOCKS, self.tr("Output Protoblocks")
            )
        )

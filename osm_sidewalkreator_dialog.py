...
FORM_CLASS, _ = uic.loadUiType(
    os.path.join(os.path.dirname(__file__), "osm_sidewalkreator_dialog_base.ui")
)


class sidewalkreatorDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(sidewalkreatorDialog, self).__init__(parent)
